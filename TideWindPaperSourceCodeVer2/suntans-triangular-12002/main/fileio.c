...
} else if(!strcmp(str,"M2TideAmplitude")) {
   return M2TideAmplitude_DEFAULT;   
} else if(!strcmp(str,"K1TideAmplitude")) {
   return K1TideAmplitude_DEFAULT;   
} else if(!strcmp(str,"TidePhaseDifference")) {
   return TidePhaseDifference_DEFAULT;   
} else if(!strcmp(str,"WindPhaseDifference")) {
   return WindPhaseDifference_DEFAULT;   
} else if(!strcmp(str,"PycnoclineDepth")) {
   return PycnoclineDepth_DEFAULT;   
} 
