...
const REAL M2TideAmplitude_DEFAULT = 0;
const REAL K1TideAmplitude_DEFAULT = 0;
const REAL TidePhaseDifference_DEFAULT = 0;
const REAL WindPhaseDifference_DEFAULT = 0;
const REAL PycnoclineDepth_DEFAULT = 0;
