...
InterpRes=100;
DataPath='/scratch/omidvar/work-directory_0801/IdealRidgeInfo.nc';
...
function ConversionPartCalculator(YRange,Part,DataPath,InterpRes,Rho0,g)
	...
	if exist(strcat('APEIdealRidge-',num2str(Part),'.nc'))~=0
		delete(strcat('APEIdealRidge-',num2str(Part),'.nc'));
	end
	ncid = netcdf.create(strcat('APEIdealRidge-',num2str(Part),'.nc'),'NETCDF4');
